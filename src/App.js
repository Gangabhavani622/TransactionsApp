...
import TransactionsBarChar from "./components/TransactionsBarChart";
import "./App.css";
...
class App extends Component {
  ...
  fetchData = async () => {
    ...
    const url = `http://localhost:5000/transactions/?search_q=${searchText}&page=${currentPage}&per_page=10&selectedMonth=${selectedMonth}`;
    try {
  ...
  render() {
    ...
    return (
        ...
        <div className="transactions-table-container">
          ...
          <TransactionsBarChar selectedMonth={selectedMonth}/>
        </div>
      </div>  
    );
  }
